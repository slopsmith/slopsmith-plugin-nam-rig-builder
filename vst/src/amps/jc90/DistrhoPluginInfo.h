...
#define DISTRHO_PLUGIN_NAME    "JC90"
#define DISTRHO_PLUGIN_URI     "urn:rigbuilder:jc90"
#define DISTRHO_PLUGIN_CLAP_ID "rigbuilder.jc90"

#define DISTRHO_PLUGIN_BRAND_ID  Rgbd
#define DISTRHO_PLUGIN_UNIQUE_ID Jc90
